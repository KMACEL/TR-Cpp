//============================================================================
// İsim        : 17_Vektor_Kullanımı
// Yazan       : Mert AceL
// Version     : 1.0
// Copyright   : AceL
// Açıklama    : Vektörlere Giriş
//============================================================================
#include <iostream>
#include <vector>
...
int main()
{
  ...
  for (unsigned int i = 0; i < vektor3.size(); i++)
  {
  ...
  for (unsigned int i = 0; i < vektor6.size(); i++)
  {
    for (unsigned int j = 0; j < vektor6[i].size(); j++)
    {
      vektor6[i][j] = i + 2 * j;
    }
  }
